...
public class AboutActivity extends BaseSwipeBackCompatActivity {
    ...
    protected void initViewsAndEvents() {
        ...
        tvGitHubUrl.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);
    ...
    @OnClick({R.id.tvGitHubUrl, R.id.tvGitHubName})
    public void openGitHub() {
        Intent intent = new Intent(this, BaseWebActivity.class);
        intent.putExtra(BaseWebActivity.BUNDLE_KEY_URL, tvGitHubUrl.getText().toString().trim());
        startActivity(intent);
    }
